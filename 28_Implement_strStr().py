...
Check to see if a string is found in another string. 
Return the index of the first occurrence of needle in haystack, or -1 if needle is not part of haystack.
What if the needle is an empty string? return 0

Given: haystack: string, needle: string
Output: an index number or 0 if needle is empty, or -1 if needle is not found in haystack
